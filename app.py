...
def newpage():
    ...
    lasso_regressor = Lasso(alpha=0.1)  # You can adjust alpha as per your requirement
    ...
    ridge_regressor = Ridge(alpha=0.1)  # You can adjust alpha as per your requirement
